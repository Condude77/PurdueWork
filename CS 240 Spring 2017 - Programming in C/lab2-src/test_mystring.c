...
int main(int argc, char ** argv) {
	...
	test = argv[1];
	printf("Running %s\n", test);
	if (mystrcmp(test, "test1")==0) {
		test1();
	}
	else if (mystrcmp(test, "test2")==0) {
		test2();
	}
	else if (mystrcmp(test, "test3")==0) {
		test3();
	}
	else if (mystrcmp(test, "test4")==0) {
		test4();
	}
	else if (mystrcmp(test, "test5")==0) {
		test5();
	}
	else if (mystrcmp(test, "test6")==0) {
		test6();
	}
	else if (mystrcmp(test, "test7")==0) {
		test7();
	}
	else {
