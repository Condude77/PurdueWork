...
uint32	clktimemilli;		/* Added for Lab 3 part 3.1 in order to keep track of each time a system timer interrupt is processed	*/
uint64 clktimetick;		/* Added for lab 3 part 3.5 in order to track clock time in cpu ticks	*/
...
void	clkinit(void)
{
	...
	/* Initialize the time since boot to zero for Lab 3 part 3.1	*/
	clktimemilli = 0;

	/* Initialize the time since boot to zero for Lab 3 part 3.5	*/
	clktimetick = 0;
